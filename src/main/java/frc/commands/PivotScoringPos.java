...
public class PivotScoringPos extends CommandBase {

  private ArmSubsystem ARM_SUBSYSTEM;
  private PIDController pidController;
  /** Creates a new PivotScoringPos. */
  public PivotScoringPos(ArmSubsystem arm, double setpoint) {
  ...
  public void initialize() {
    pidController.reset();
    System.out.println("Arm Score position PID started");
  }
  ...
  public void end(boolean interrupted) {
    ARM_SUBSYSTEM.stop();
    System.out.println("Arm Score position PID ended");
  }
