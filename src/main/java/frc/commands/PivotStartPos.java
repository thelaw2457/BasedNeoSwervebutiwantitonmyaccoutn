...
public class PivotStartPos extends CommandBase {

  private ArmSubsystem ARM_SUBSYSTEM;
  private PIDController pidController;
  /** Creates a new PivotStartPos. */
  public PivotStartPos(ArmSubsystem arm, double setpoint) {
  ...
  public void initialize() {
    pidController.reset();
    System.out.println("Arm Start position PID started");
  }
  ...
  public void end(boolean interrupted) {
    ARM_SUBSYSTEM.stop();
    System.out.println("Arm Start position PID ended");
  }
